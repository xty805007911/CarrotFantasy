...
public class BulletOfStar extends Bullets{
	private static BufferedImage[] images=new BufferedImage[3];
	static {

		try {
			for(int i=0;i<images.length;i++) {
				images[i] = ImageIO.read(BulletOfTBottle.class.getResource("../png/BulletOfStar"+i+".png"));
			}
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public BulletOfStar(int x, int y, double angrad,int level,int cannon_shot,int ATK) {
